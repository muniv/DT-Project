...
public class MainActivity extends AppCompatActivity {
    ...
    public static ComponentName service = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceIntent = new Intent(getApplicationContext(), CallingService.class);
...
*/
                service = getApplicationContext().startService(serviceIntent);
                i = new Intent();
