...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final int position_this=position;

        // 화면에 표시될 View(Layout이 inflate된)으로부터 위젯에 대한 참조 획득
        TextView nameTextView = (TextView) convertView.findViewById(R.id.textView_name) ;
        TextView phoneTextView = (TextView) convertView.findViewById(R.id.textView_phone) ;
        ...
        Button callButton=(Button) convertView.findViewById(R.id.button_call);
